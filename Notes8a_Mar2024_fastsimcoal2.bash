...
# add bottleneck models
# make a copy of the old Mar 2023 folder in scratch/Cassiope/

scp Fastsimcoal2_May2023.tar.gz celphin@beluga.computecanada.ca:~/scratch/Cassiope/
tar -xzf Fastsimcoal2_May2023.tar.gz
mv Fastsimcoal2_Mar2023 Fastsimcoal2_Nov2023

###########################################
# Example bottleneck models from Fernando
...
# 1  P1popsize     unif     100  1000000   output
# 1  P2popsize     unif     100  1000000   output
# 1  P3popsize     unif     100  1000000   output
# 1  TDIV1         unif     10   500     output bounded
# 0  BOT         unif  0.01 1        output
# 0  MIG1         unif  0 0.5        output
# 0  MIG2         unif  0 0.5        output

############################################
# Add bottlenecks to all models

mkdir  Fastsimcoal2_Mar2024
cd /home/celphin/scratch/Cassiope/Fastsimcoal2_Mar2024
...
#mkdir runs; cd runs
cd ~/scratch/Cassiope/Fastsimcoal2_Mar2024/runs
